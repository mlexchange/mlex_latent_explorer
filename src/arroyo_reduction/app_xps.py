...
from .xps_tiled_local_image_publisher import (
    XPSTiledLocalImagePublisher,
)  # NEW: Add this import
...
async def start() -> None:
    try:
        ...
        xps_local_image_publisher = XPSTiledLocalImagePublisher.from_settings(
            app_settings.local_image_publisher
        )
        ...
        listener = XPSWebSocketListener.from_settings(
            app_settings.xps_listener, operator
        )
